...
HD_PWD='D:/slim/WHUT/JiChuang/XiaoSai/hdmi_loop/hdmi_loop.runs/edid_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edid_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edid_rom.tcl
