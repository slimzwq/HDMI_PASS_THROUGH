...
namespace eval ::optrace {
  variable script "D:/slim/WHUT/JiChuang/XiaoSai/hdmi_loop/hdmi_loop.runs/impl_1/hdmi_loop.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/slim/WHUT/JiChuang/XiaoSai/hdmi_loop/hdmi_loop.runs/synth_1/hdmi_loop.dcp
...
OPTRACE "link_design" START { }
  link_design -top hdmi_loop -part xc7a35tfgg484-2 
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi hdmi_loop.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force hdmi_loop.bit -bin_file
